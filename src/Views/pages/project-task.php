<div class="projects-layout">
    ...
    <main>
        ...
        <div class="project-header">
            ...
            <button type="button" class="app-btn app-btn--primary">+ Ajouter une tâche</button>
            <div class="project-btn">
                <div class="project-rename">
                    <form method="POST" action="/projects/rename">
                        ...
                        <input type="text" name="name" required maxlength="255" value="<?= htmlspecialchars($project['name'], ENT_QUOTES, 'UTF-8') ?>" autocomplete="off">
